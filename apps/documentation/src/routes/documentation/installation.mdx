...
`Tuono` is a development environment built in rust and typescript and the output website will be written with both the
languages. Since that you need the following tools installed in your computer to work with Tuono:
...
> NodeJs is needed just for the development environment
